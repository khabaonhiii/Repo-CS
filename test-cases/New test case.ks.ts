...
export default katalon.testCase("New Test Case", async ({ local, web }) => {
  ...
  await web.click({
    type: "Web",
    id: "56ce3d28-8068-4825-97d0-cd02f57d843e",
    attributes: {
    ...
    selectors: [
      {
        id: "d903fbc6-48ea-4092-a332-aa245c50e161",
        type: "CSS",
        value: "#btn-make-appointment",
        isDefault: true,
      },
      {
        id: "1b48a6b4-de44-4ed5-875f-587043ea5e84",
        type: "Attribute",
        value: null,
        isDefault: true,
      },
  ...
  await web.click({
    ...
    childIndex: 2,
    hashes: { "md5.v1": "4073a481123fd6a126ddb83bded49850" },
    name: "div - form-group",
    selectors: [
      {
  ...
  await web.click({
    ...
    childIndex: 2,
    hashes: { "md5.v1": "d35888a13dd032e4b68a83a631d463e7" },
    name: "div - col-sm-8",
    selectors: [
      {
